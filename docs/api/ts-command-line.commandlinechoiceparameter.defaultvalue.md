...
[Home](./index.md) &gt; [@rushstack/ts-command-line](./ts-command-line.md) &gt; [CommandLineChoiceParameter](./ts-command-line.commandlinechoiceparameter.md) &gt; [defaultValue](./ts-command-line.commandlinechoiceparameter.defaultvalue.md)
