...
[Home](./index.md) &gt; [@rushstack/ts-command-line](./ts-command-line.md) &gt; [CommandLineRemainder](./ts-command-line.commandlineremainder.md) &gt; [appendToArgList](./ts-command-line.commandlineremainder.appendtoarglist.md)

## CommandLineRemainder.appendToArgList() method
