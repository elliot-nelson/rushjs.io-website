...
[Home](./index.md) &gt; [@rushstack/ts-command-line](./ts-command-line.md) &gt; [CommandLineIntegerParameter](./ts-command-line.commandlineintegerparameter.md) &gt; [appendToArgList](./ts-command-line.commandlineintegerparameter.appendtoarglist.md)
